...
Para el desarrollo de la aplicación se han utilizado los componentes html y CSS integrados en Dash además de una plantilla libre de Bootstrap para componer el estilo de la página.
